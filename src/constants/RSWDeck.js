const cards = [
    ...
    {
        name: "The Heirophant",
        nameReversed: "The Heirophant (Reversed)",
        arcana: "Major Arcana",
    ...
    {
        name: "The Lovers",
        nameReversed: "The Lovers (Reversed)",
        arcana: "Major Arcana",
        meaning: "Attraction, love, beauty, trials overcome.",
        meaningReversed: "Failure, foolish designs. Another account speaks of marriage frustrated and contrarieties of all kinds.",
    ...
    {
        name: "The Chariot",
        nameReversed: "The Chariot (Reversed)",
        arcana: "Major Arcana",
    ...
    {
        name: "Strength",
        nameReversed: "Strength (Reversed)",
        arcana: "Major Arcana",
        meaning: "Power, energy, action, courage, magnanimity; also complete success and honours.",
        meaningReversed: "Despotism, abuse if power, weakness, discord, sometimes even disgrace.",
    ...
    {
        name: "The Hermit",
        nameReversed: "The Hermit (Reversed)",
        arcana: "Major Arcana",
    ...
    },
    {
        ...
        nameReversed: "Wheel of Fortune (Reversed)",
        arcana: "Major Arcana",
    ...
    {
        name: "Justice",
        nameReversed: "Justice (Reversed)",
        arcana: "Major Arcana",
        meaning: "Equity, rightness, probity, executive; triumph of the deserving side in law.",
        meaningReversed: "Law in all its departments, legal complications, bigotry, bias, excessive severity.",
    ...
    {
        name: "The Hanged Man",
        nameReversed: "The Hanged Man (Reversed)",
        arcana: "Major Arcana",
    ...
    {
        name: "Temperance",
        nameReversed: "Temperance (Reversed)",
        arcana: "Major Arcana",
        meaning: "Economy, moderation, frugality, management, accommodation.",
        meaningReversed: "Things connected with churches, religions, sects, the priesthood, sometimes even the priest who will marry the Querent; also disunion, unfortunate combinations, competing interests.",
    ...
    {
        name: "The Devil",
        nameReversed: "The Devil (Reversed)",
        arcana: "Major Arcana",
    ...
    {
        name: "The Tower",
        nameReversed: "The Tower (Reversed)",
        arcana: "Major Arcana",
        ...
        meaningReversed: "According to one account, the same in a lesser degree also oppression, imprisonment, tyranny.",
    ...
    {
        name: "The Star",
        nameReversed: "The Star (Reversed)",
        arcana: "Major Arcana",
    ...
    {
        name: "The Moon",
        nameReversed: "The Moon (Reversed)",
        arcana: "Major Arcana",
    ...
    {
        name: "Judgement",
        nameReversed: "Judgement (Reversed)",
        arcana: "Major Arcana",
    ...
    {
        name: "The World",
        nameReversed: "The World (Reversed)",
        arcana: "Major Arcana",
    ...
    {
        name: "Ace of Wands",
        nameReversed: "Ace of Wands (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Two of Wands",
        nameReversed: "Two of Wands (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Three of Wands",
        nameReversed: "Three of Wands (Reversed)",
        arcana: "Minor Arcana",
        meaning: "He symbolizes established strength, enterprise, effort, trade, commerce, discovery; those are his ships, bearing his merchandise, which are sailing over the sea. The card also signifies able co-operation in business, as if the successful merchant prince were looking from his side towards yours with a view to help you.",
        meaningReversed: "The end of troubles, suspension or cessation of adversity, toil and disappointment.",
    ...
    {
        name: "Four of Wands",
        nameReversed: "Four of Wands (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "The meaning remains unaltered; it is prosperity, increase, felicity, beauty, embellishment.",
    ...
    {
        name: "Five of Wands",
        nameReversed: "Five of Wands (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Six of Wands",
        nameReversed: "Six of Wands (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "Apprehension, fear, as of a victorious enemy at the gate; treachery, disloyalty, as of gates being opened to the enemy; also indefinite delay.",
    ...
    {
        name: "Seven of Wands",
        nameReversed: "Seven of Wands (Reversed)",
        arcana: "Minor Arcana",
        meaning: "It is a card of valour, for, on the surface, six are attacking one, who has, however, the vantage position. On the intellectual plane, it signifies discussion, wordy strife; in business - negotiations, war of trade, barter, competition. It is further a card of success, for the combatant is on the top and his enemies may be unable to reach him.",
        meaningReversed: "Perplexity, embarrassments, anxiety. It is also a caution against indecision.",
    ...
    {
        name: "Eight of Wands",
        nameReversed: "Eight of Wands (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "Arrows of jealousy, internal dispute, stingings of conscience, quarrels; and domestic disputes for persons who are married.",
    ...
    {
        name: "Nine of Wands",
        nameReversed: "Nine of Wands (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Ten of Wands",
        nameReversed: "Ten of Wands (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Page of Wands",
        nameReversed: "Page of Wands (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "Anecdotes, announcements, evil news. Also indecision and the instability which accompanies it.",
    ...
    },
    {
        ...
        nameReversed: "Knight of Wands (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Queen of Wands",
        nameReversed: "Queen of Wands (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "Good, economical, obliging, serviceable. Signifies also - but in certain positions and in the neighbourhood of other cards tending in such directions - opposition, jealousy, even deceit and infidelity.",
    ...
    {
        name: "King of Wands",
        nameReversed: "King of Wands (Reversed)",
        arcana: "Minor Arcana",
    ...
    },
    {
        ...
        nameReversed: "Ace of Pentacles (Reversed)",
        arcana: "Minor Arcana",
        meaning: "Perfect contentment, felicity, ecstasy; also speedy intelligence; gold.",
        meaningReversed: "The evil side of wealth, bad intelligence; also great riches. In any case it shews prosperity, comfortable material conditions, but whether these are of advantage to the possessor will depend on whether the card is reversed or not.",
    ...
    },
    {
        ...
        nameReversed: "Two of Pentacles (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "Enforced gaiety, simulated enjoyment, literal sense, handwriting, composition, letters of exchange.",
    ...
    },
    {
        ...
        nameReversed: "Three of Pentacles (Reversed)",
        arcana: "Minor Arcana",
        meaning: "Metier, trade, skilled labour; usually, however, regarded as a card of nobility, aristocracy, renown, glory.",
        meaningReversed: "Mediocrity, in work and otherwise, puerility, pettiness, weakness.",
    ...
    },
    {
        ...
        nameReversed: "Four of Pentacles (Reversed)",
        arcana: "Minor Arcana",
    ...
    },
    {
        ...
        nameReversed: "Five of Pentacles (Reversed)",
        arcana: "Minor Arcana",
    ...
    },
    {
        ...
        nameReversed: "Six of Pentacles (Reversed)",
        arcana: "Minor Arcana",
    ...
    },
    {
        ...
        nameReversed: "Seven of Pentacles (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "Cause for anxiety regarding money which it may be proposed to lend.",
    ...
    },
    {
        ...
        nameReversed: "Eight of Pentacles (Reversed)",
        arcana: "Minor Arcana",
        meaning: "Work, employment, commission, craftsmanship, skill in craft and business, perhaps in the preparatory stage.",
        meaningReversed: "Voided ambition, vanity, cupidity, exaction, usury. It may also signify the possession of skill, in the sense of the ingenious mind turned to cunning and intrigue.",
    ...
    },
    {
        ...
        nameReversed: "Nine of Pentacles (Reversed)",
        arcana: "Minor Arcana",
    ...
    },
    {
        ...
        nameReversed: "Ten of Pentacles (Reversed)",
        arcana: "Minor Arcana",
        meaning: "Gain, riches; family matters, archives, extraction, the abode of a family.",
        meaningReversed: "Chance, fatality, loss, robbery, games of hazard; sometimes gift, dowry, pension.",
    ...
    },
    {
        ...
        nameReversed: "Page of Pentacles (Reversed)",
        arcana: "Minor Arcana",
    ...
    },
    {
        ...
        nameReversed: "Knight of Pentacles (Reversed)",
        arcana: "Minor Arcana",
        meaning: "Utility, serviceableness, interest, responsibility, rectitude-all on the normal and external plane.",
        meaningReversed: "Inertia, idleness, repose of that kind, stagnation; also placidity, discouragement, carelessness.",
    ...
    },
    {
        ...
        nameReversed: "Queen of Pentacles (Reversed)",
        arcana: "Minor Arcana",
    ...
    },
    {
        ...
        nameReversed: "King of Pentacles (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Ace of Cups",
        nameReversed: "Ace of Cups (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Two of Cups",
        nameReversed: "Two of Cups (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "Favourable in things of pleasure and business, as well as love; also wealth and honour.",
    ...
    {
        name: "Three of Cups",
        nameReversed: "Three of Cups (Reversed)",
        arcana: "Minor Arcana",
        meaning: "The conclusion of any matter in plenty, perfection and merriment; happy issue, victory, fulfilment, solace, healing.",
        meaningReversed: "Expedition, dispatch, achievement, end. It signifies also the side of excess in physical enjoyment, and the pleasures of the senses.",
    ...
    {
        name: "Four of Cups",
        nameReversed: "Four of Cups (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Five of Cups",
        nameReversed: "Five of Cups (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Six of Cups",
        nameReversed: "Six of Cups (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Seven of Cups",
        nameReversed: "Seven of Cups (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Eight of Cups",
        nameReversed: "Eight of Cups (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Nine of Cups",
        nameReversed: "Nine of Cups (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "Truth, loyalty, liberty; but the readings vary and include mistakes, imperfections, etc.",
    ...
    {
        name: "Ten of Cups",
        nameReversed: "Ten of Cups (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Page of Cups",
        nameReversed: "Page of Cups (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Knight of Cups",
        nameReversed: "Knight of Cups (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Queen of Cups",
        nameReversed: "Queen of Cups (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "The accounts vary; good woman; otherwise, distinguished woman but one not to be trusted; perverse woman; vice, dishonour, depravity.",
    ...
    {
        name: "King of Cups",
        nameReversed: "King of Cups (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "Dishonest, double-dealing man; roguery, exaction, injustice, vice, scandal, pillage, considerable loss.",
    ...
    {
        name: "Ace of Swords",
        nameReversed: "Ace of Swords (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "The same, but the results are disastrous; another account says - conception, childbirth, augmentation, multiplicity.",
    ...
    {
        name: "Two of Swords",
        nameReversed: "Two of Swords (Reversed)",
        arcana: "Minor Arcana",
    ...
    },
    {
        ...
        nameReversed: "Three of Swords (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Four of Swords",
        nameReversed: "Four of Swords (Reversed)",
        arcana: "Minor Arcana",
        meaning: "Vigilance, retreat, solitude, hermit's repose, exile, tomb and coffin. It is these last that have suggested the design.",
        meaningReversed: "Wise administration, circumspection, economy, avarice, precaution, testament.",
    ...
    {
        name: "Five of Swords",
        nameReversed: "Five of Swords (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Six of Swords",
        nameReversed: "Six of Swords (Reversed)",
        arcana: "Minor Arcana",
        meaning: "Journey by water, route, way, envoy, commissionary, expedient.",
        meaningReversed: "Declaration, confession, publicity; one account says that it is a proposal of love.",
    ...
    },
    {
        ...
        nameReversed: "Seven of Swords (Reversed)",
        arcana: "Minor Arcana",
    ...
    },
    {
        ...
        nameReversed: "Eight of Swords (Reversed)",
        arcana: "Minor Arcana",
        meaning: "Bad news, violent chagrin, crisis, censure, power in trammels, conflict, calumny; also sickness.",
        meaningReversed: "Disquiet, difficulty, opposition, accident, treachery; what is unforeseen; fatality.",
    ...
    {
        name: "Nine of Swords",
        nameReversed: "Nine of Swords (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "Ten of Swords",
        nameReversed: "Ten of Swords (Reversed)",
        arcana: "Minor Arcana",
        ...
        meaningReversed: "Advantage, profit, success, favour, but none of these are permanent; also power and authority.",
    ...
    {
        name: "Page of Swords",
        nameReversed: "Page of Swords (Reversed)",
        arcana: "Minor Arcana",
        meaning: "Authority, overseeing, secret service, vigilance, spying, examination, and the qualities thereto belonging.",
        meaningReversed: "More evil side of these qualities; what is unforeseen, unprepared state; sickness is also intimated.",
    ...
    },
    {
        ...
        nameReversed: "Knight of Swords (Reversed)",
        arcana: "Minor Arcana",
    ...
    },
    {
        ...
        nameReversed: "Queen of Swords (Reversed)",
        arcana: "Minor Arcana",
    ...
    {
        name: "King of Swords",
        nameReversed: "King of Swords (Reversed)",
        arcana: "Minor Arcana",
